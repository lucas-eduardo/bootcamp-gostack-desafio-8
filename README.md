...
Basta executar o yarn install, logo em seguinda yarn server e depois rodar a aplicação via usb (lembrando de verificar o host da rede, para o dispositivo conseguir fazer os requests no json-server)
